...
class MyColorFieldDivFormatter extends FormatterBase {
   ...
   * {@inheritdoc}
   *
   * Настройки за замовчуванням для нашого формату виведення.
   */
   ...
   * {@inheritdoc}
   *
   * Форма з настройками для нашого формату виведення.
   */
   ...
   * {@inheritdoc}
   *
   * Данний метод дозволяє вивести коротку інформацію про поточних налаштуваннях поля
   * на сторінці управління відображенням
   */
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      // Відобразити кожен елемент як розмітку.
      $element[$delta] = [
        '#type' => 'markup',
